...
public class AssignmentSolutionActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtDetails = findViewById(R.id.edtDetails);
         ...
         assignmentitle = getIntent().getStringExtra("assignmentitle");
         assignmentid = getIntent().getStringExtra("assignmentid");
         edtTitle.setText(assignmentitle);
        ...
        switch (v.getId()) {
            case R.id.imgAttachment:
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    AssignmentSolutionActivity.super.requestAppPermissions(new
            ...
            case R.id.relativeDone:
               ...
               // if (listClass.size() > 0) {
                ...
                //}
                //if (listClass.size() == 0) {
                   // ShowError(AssignmentSolutionActivity.this, "Sorry", "You could not upload any file at this time");
               // } else
                if (strPath.equals("")) {
                    ShowError(AssignmentSolutionActivity.this, "Error", "Please attach file");
                } else {
                    try {
    ...
    public void getRetro_UploadDocument(final JSONObject itemData) throws JSONException {
        ...
        builder.addFormDataPart("assignmentid", itemData.getString("assignmentid"));
        ...
        final Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Request request = new Request.Builder()
                        .url(Vars.Live_Attachment_Assignment_Soln)
                        .post(request_body)
                        .build();
