...
public class ActivateActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtMobileNumber = findViewById(R.id.edtNemisNumber);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnActivate:
                boolean Error = false;
                String strPhoneNumber = edtMobileNumber.getText().toString();
                /////String strPassword = edtPassword.getText().toString();

                if (strPhoneNumber.equals("") || !ValidateMobileNumber(strPhoneNumber)) {
               ...
               //////// }
                ...
                if (Error) {
                    ...
                    startActivity(new Intent(ActivateActivity.this,TeachersFillActivity.class)
                            .putExtra("phonenumber", strPhoneNumber)
                            .putExtra("role", strRole));
                }

                /////////else {
                   ////// getRetro_CheckActivation(strPhoneNumber, strPassword, strRole);
               ///// }
                break;
            case R.id.imgBack:
                onBackPressed();
    ...
    public void getRetro_CheckActivation(final String phone, final String password, final String role) {
        getRetro_Call(ActivateActivity.this, service.getCheckActivation(phone, role), true, new API_Calls.OnApiResult() {
            @Override
            public void onSuccess(Response<Object> objectResponse) {
                ...
                if (mPojo_Active != null) {
                    if (mPojo_Active.getStatus().equals(API_Code.Success)) {
                        startActivity(new Intent(ActivateActivity.this, VerifyActivity.class)
                                .putExtra("phone", phone)
                                .putExtra("password", password)
                                .putExtra("role", role)
                                .putExtra("otp", mPojo_Active.getOtp()));
                    } else {
                        ShowError(ActivateActivity.this, "Error", mPojo_Active.getMessage());
                    }
                }
            }
